<form action="<?php echo url('user/login.html'); ?>" method="post">
	...
	<div class="text-right">
		...
		<a href="<?php echo url('user.html'); ?>" class="btn btn-primary" data-toggle="tooltip" title="S'inscrire sur le site"><i class="fa fa-sign-in"></i></a>
		<a href="<?php echo url('user/lost-password.html'); ?>" class="btn btn-primary" data-toggle="tooltip" title="Mot de passe perdu ?"><i class="fa fa-question"></i></a>
	</div>
</form>